...
(function() {
    ...
    //*PLEX*/ janrain.settings.appUrl                = 'https://cavs-dev.rpxnow.com';
    janrain.settings.capture.captureServer = 'https://gladiators-dev.us-dev.janraincapture.com';
    //*PLEX*/ janrain.settings.capture.appId         = 'kn34svgmt5tdcnzn299h5pquw9';
    //*PLEX*/ janrain.settings.capture.clientId      = '87pczh69b9cqkpjbzynugxjwsrhu4247';

    // These are the URLs for your Engage app's load.js file, which is necessary
    // to load the Capture Widget.
    //*PLEX*/ var httpLoadUrl  = "http://widget-cdn.rpxnow.com/load/cavs-dev";
    //*PLEX*/ var httpsLoadUrl = "https://rpxnow.com/load/cavs-dev";


    // --- Engage Widget Settings ----------------------------------------------
    //*PLEX*/ janrain.settings.language = 'en-US';
    //*PLEX*/ janrain.settings.tokenUrl = 'http://localhost/';
    //*PLEX*/ janrain.settings.tokenAction = 'event';
    ...
    //*PLEX*/ janrain.settings.capture.redirectUri = 'http://localhost/';
    ...
    //*PLEX*/ janrain.settings.capture.responseType = 'token';
    janrain.settings.capture.returnExperienceUserData = ['displayName'];
    //*PLEX*/ janrain.settings.capture.stylesheets = ['styles/janrain.css'];
    //*PLEX*/ janrain.settings.capture.mobileStylesheets = ['styles/janrain-mobile.css'];
    ...
    //*PLEX*/ janrain.settings.capture.registerFlow = 'socialMobileRegistration'



    // --- Federate ------------------------------------------------------------
    //*PLEX*/ janrain.settings.capture.federate = true;
    //*PLEX*/ janrain.settings.capture.federateServer = '';
    //*PLEX*/ janrain.settings.capture.federateXdReceiver = '';
    //*PLEX*/ janrain.settings.capture.federateLogoutUri = '';
    //*PLEX*/ janrain.settings.capture.federateLogoutCallback = function() {};
    //*PLEX*/ janrain.settings.capture.federateEnableSafari = false;


    // --- Backplane -----------------------------------------------------------
    //*PLEX*/ janrain.settings.capture.backplane = true;
    //*PLEX*/ janrain.settings.capture.backplaneBusName = 'cavs-dev-bus';
...
function janrainCaptureWidgetOnLoad() {
    ...
    /*--
        ...
        that screen will be shown when the Widget loads.
                                                                            --*/
    //*PLEX*/ janrain.settings.capture.screenToRender = implFuncs.getParameterByName('screenToRender');
    ...
    /*--
        ...
        needs. These event handlers are provided as an example.
                                                                            --*/
    //*PLEX*/ janrain.events.onCaptureLoginSuccess.addHandler(implFuncs.setNavigationForLoggedInUser);
    //*PLEX*/ janrain.events.onCaptureSessionFound.addHandler(implFuncs.setNavigationForLoggedInUser);
    //*PLEX*/ janrain.events.onCaptureRegistrationSuccess.addHandler(implFuncs.setNavigationForLoggedInUser);
    //*PLEX*/ janrain.events.onCaptureSessionEnded.addHandler(implFuncs.setNavigationForLoggedOutUser);
   ...
   //Initialize Engagement User
    janrain.events.onCaptureLoginSuccess.addHandler(function(response) {
        ...
        Arktan.initializeEngagementUser(uuid, entityType, appkey); /* Commented out per ticket 19904*/
    });
